        ...
        (
        	new OnClickListener() {
				public void onClick(View v) {
                    /*
					Intent in = new Intent(Sample4_5_Activity.this, TimeService.class);
					ComponentName name = Sample4_5_Activity.this.startService(in);
					Log.d("hjz","start service");
					return;
                    */
